...
public class RepsolCamera extends AppCompatActivity implements View.OnTouchListener {
    ...
    private TextView mBubbleView, selection_ok, img_count, tv_longclick_explaining;
    private ImageView mHandleView, clickme, selection_back;
    private ViewPropertyAnimator mScrollbarAnimator;
    private ViewPropertyAnimator mBubbleAnimator;
    private FrameLayout fl_topbar;
                ...
                switch (newState) {
                    case RecyclerView.SCROLL_STATE_DRAGGING:
                        ...
                        if (!Utility.isViewVisible(mScrollbar) && (recyclerView.computeVerticalScrollRange() - mViewHeight > 0)) {
                            mScrollbarAnimator = Utility.showScrollbar(mScrollbar, RepsolCamera.this);
                        }
                        break;
            ...
            if (LongSelection) {
                if (selectionList.contains(img)) {
                    ...
                    if (SelectionCount <= selectionList.size()) {
                        Toast.makeText(RepsolCamera.this, String.format(getResources().getString(R.string.selection_limiter_pix), selectionList.size()), Toast.LENGTH_SHORT).show();
                        return;
                    }
                ...
                selection_count.setText(selectionList.size() + " fotos seleccionadas");
    ...
    public static void start(Activity context, int requestCode) {
        Intent i = new Intent(context, RepsolCamera.class);
    ...
    public static void start(final Fragment context, final int requestCode, final int selectionCount) {
        Intent i = new Intent(context.getActivity(), RepsolCamera.class);
        i.putExtra(SELECTION, selectionCount);
        context.startActivityForResult(i, requestCode);
    }
    ...
    private void initialize() {
        ...
        colorPrimaryDark = ResourcesCompat.getColor(getResources(), R.color.orangeRepsol, getTheme());
        ...
        if (SelectionCount > 1) {
            tv_longclick_explaining.setText("Recuerda que puedes seleccionar mas de una foto sí las mantienes pulsadas");
        } else {
            FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT,
                    getResources().getDimensionPixelSize(R.dimen.dimen_topbar_only_one_element_height));
            topbar.setLayoutParams(lp);
        }
        bottomButtons = findViewById(R.id.bottomButtons);
        TOPBAR_HEIGHT = Utility.convertDpToPixel(56, RepsolCamera.this);
        ...
        photoResult.toBitmap(scaled(0.25f))
                .whenDone(new WhenDoneListener<BitmapPhoto>() {
                    ...
                    public void whenDone(@Nullable BitmapPhoto bitmapPhoto) {
                        ...
                        File photo = Utility.writeImage(bitmapPhoto);
                        selectionList.clear();
    ...
    private void updateImages() {
        ...
        Cursor cursor = Utility.getCursor(RepsolCamera.this);
        ...
        }.execute(Utility.getCursor(RepsolCamera.this));
    ...
    private void setBottomSheetBehavior() {
        ...
        mBottomSheetBehavior.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onSlide(@NonNull View bottomSheet, float slideOffset) {
                Utility.manupulateVisibility(RepsolCamera.this, slideOffset,
                        instantRecyclerView, recyclerView, status_bar_bg,
                        topbar, bottomButtons, sendButton, LongSelection);
                if (slideOffset == 1) {
                    Utility.showScrollbar(mScrollbar, RepsolCamera.this);
    ...
    private void setViewPositions(float y) {
        ...
        mBubbleView.setY(handleY + Utility.convertDpToPixel((56), RepsolCamera.this));
